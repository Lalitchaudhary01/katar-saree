...
const Navbar = () => {
  ...
  return (
    <>
      {/* Font styles added to the parent div to apply to all elements */}
      <div className="font-['Cardo',serif] text-[14px]">
        ...
        {!scrolled && (
          <div className="w-full bg-[#5d4037] text-white py-2 px-4 flex justify-center items-center z-50 relative">
            <div className="flex items-center">
              <span>
                Free shipping within India | Free international shipping on
                orders over Rs. 25,000
              </span>
